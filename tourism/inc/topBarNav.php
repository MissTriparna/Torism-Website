 ...
 <nav class="navbar navbar-expand-lg navbar-dark fixed-top navbar-shrink" id="mainNav">
            <div class="container-fluid">
                <a class="navbar-brand" href="#page-top"><span class="text-waring">रांगाMAATI</span></a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="http://localhost/carrental/">Book a Ride</a></li>
                        <li class="nav-item"><a class="nav-link" href="http://localhost/ecommerce/">Ecommerce</a></li>
                        
                       
                        <li class="nav-item"><a class="nav-link" href="http://localhost/project/">Book a Hotel</a></li>
